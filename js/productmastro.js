...
const navLinks = document.querySelectorAll('.mastro-nav-link');
...
const stickyWrapper = document.querySelector('.mastro-sticky-wrapper');
const navContainer = document.querySelector('.mastro-sticky-nav-container');
const mainBodyWrapper = document.querySelector('.mastro-main-body-wrapper');
