document.addEventListener('DOMContentLoaded', () => {
    ...
    const initProgressBar = () => {
        const slider = document.querySelector('.riva-logo-strip, .alpi-logo-strip, .mastro-logo-strip');
        const thumb = document.querySelector('.riva-smallprogress-bar, .alpi-smallprogress-bar, .mastro-smallprogress-bar');
        const track = document.querySelector('.riva-smallprogress-container, .alpi-smallprogress-container, .mastro-smallprogress-container');
