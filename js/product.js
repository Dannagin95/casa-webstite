document.addEventListener('DOMContentLoaded', () => {
    ...
    const initHeroSlider = () => {
        ...
        const playBtn = document.getElementById('riva-video-play-btn');
        const progressContainer = document.getElementById('riva-video-progress-container');
        const progressBar = document.getElementById('riva-video-progress-bar');
        ...
        if (container) {
            ...
            container.addEventListener('click', (e) => {
                ...
                if (item && item.type === 'video' && window.innerWidth < 1024) {
                    if (e.target.closest('#riva-video-play-btn')) return;
        ...
        container.addEventListener('touchend', (e) => {
            if (e.target.closest('#riva-video-play-btn') || e.target.closest('#riva-video-progress-container')) return;
    ...
    const initGalleryScroll = () => {
        const grid = document.querySelector('.riva-gallery-grid');
        const progressBar = document.querySelector('.riva-progress-bar');
        const container = document.querySelector('.riva-progress-container');
    ...
    const initProductLightbox = () => {
        ...
        const heroContainer = document.querySelector('.riva-hero-container');
        if (heroContainer) {
            heroContainer.style.cursor = "pointer";
            heroContainer.addEventListener('click', (e) => {
                if (e.target.closest('#riva-video-play-btn') || e.target.closest('#riva-video-progress-container')) {
                    return;
                }
        ...
        const gridImages = Array.from(document.querySelectorAll('.riva-gallery-grid .riva-photo img'));
