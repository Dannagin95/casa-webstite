...
const initGalleryScroll = () => {
    const gallery = document.querySelector('.firstblog-gallery-grid, .thirdblog-gallery-grid, .fourthblog-gallery-grid, .fifthblog-gallery-grid, .sixblog-gallery-grid, .seventhblog-gallery-grid, .eighthblog-gallery-grid, .ninthblog-gallery-grid, .tenthblog-gallery-grid');
    const progress = document.querySelector('.scroll-progress');
    const indicator = document.querySelector('.blog-scroll-indicator, .thirdblog-scroll-indicator, .fourthblog-scroll-indicator, .fifthblog-scroll-indicator, .sixblog-scroll-indicator, .seventhblog-gallery-grid, .eighthblog-gallery-grid, .ninthblog-gallery-grid, .tenthblog-gallery-grid');
